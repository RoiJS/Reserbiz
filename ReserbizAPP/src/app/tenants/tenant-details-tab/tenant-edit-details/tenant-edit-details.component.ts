      ...
      this.dialogService
        .confirm(
          this.translateService.instant(
            'TENANTS_DETAILS_PAGE.UPDATE_TENANT_FORM_CONTROL.UPDATE_DIALOG.TITLE'
          ),
          this.translateService.instant(
            'TENANTS_DETAILS_PAGE.UPDATE_TENANT_FORM_CONTROL.UPDATE_DIALOG.CONFIRM_MESSAGE'
          )
        )
        .then((res) => {
              ...
              .subscribe(
                () => {
                  this.dialogService.alert(
                    ...
                    this.translateService.instant(
                      'TENANTS_DETAILS_PAGE.UPDATE_TENANT_FORM_CONTROL.UPDATE_DIALOG.SUCCESS_MESSAGE'
                    ),
                    () => {
                      this._tenantFormSourceOriginal = this._tenantFormSource.clone();
                      this.router.back();
                ...
                (error: Error) => {
                  this.dialogService.alert(
                    ...
                    this.translateService.instant(
                      'TENANTS_DETAILS_PAGE.UPDATE_TENANT_FORM_CONTROL.UPDATE_DIALOG.ERROR_MESSAGE'
                    )
                  );
                }
              );
