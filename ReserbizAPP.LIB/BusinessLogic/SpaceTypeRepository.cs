...
namespace ReserbizAPP.LIB.BusinessLogic
{
        ...
        : BaseRepository<SpaceType>, ISpaceTypeRepository<SpaceType>
    {
        ...
        public async Task<bool> CheckSpaceTypeAvailability(int spaceTypeId)
        {
            ...
            var spaceTypeFromRepo = await GetEntity(spaceTypeId)
                                        .Includes(s => s.Spaces)
                                        .ToObjectAsync();
            var spaceTypeUsedSlot = await GetSpaceTypeCurrentUsedSlot(spaceTypeId);

            var spaceTypeCurrentSlot = spaceTypeFromRepo.Spaces.Count;
        ...
        private async Task<int> GetSpaceTypeCurrentUsedSlot(int spaceTypeId)
        {
            ...
            var usedSlot = spaceTypesWithTermsAndContracts != null ? spaceTypesWithTermsAndContracts.UsedSlot : 0;
