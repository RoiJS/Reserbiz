...
namespace ReserbizAPP.LIB.Dtos
{
    public class TermForUpdateDto
    {
        ...
        [Required]
        [DurationValueRange("DurationUnit", ErrorMessage = "Value for duration unit of {0} shall be not exceed to  {1}.")]
        ...
        [Required]
        [DurationValueRange("PenaltyEffectiveAfterDurationUnit", ErrorMessage = "Value for duration unit of {0} shall be not exceed to {1}.")]
