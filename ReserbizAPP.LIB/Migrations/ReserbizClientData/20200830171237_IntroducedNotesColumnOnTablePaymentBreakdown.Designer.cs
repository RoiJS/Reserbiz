...
namespace ReserbizAPP.LIB.Migrations.ReserbizClientData
{
    ...
    [Migration("20200830171237_IntroducedNotesColumnOnTablePaymentBreakdown")]
    partial class IntroducedNotesColumnOnTablePaymentBreakdown
    {
            ...
            modelBuilder.Entity("ReserbizAPP.LIB.Models.Term", b =>
                {
                    ...
                    b.HasOne("ReserbizAPP.LIB.Models.SpaceType", "SpaceType")
                        .WithOne("Term")
                        .HasForeignKey("ReserbizAPP.LIB.Models.Term", "SpaceTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
