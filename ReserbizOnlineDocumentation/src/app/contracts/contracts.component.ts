  ...
  implements OnInit, OnDestroy, AfterViewInit, AfterViewChecked
{
  ...
  setDatasource(): void {
    ...
    this.dataSource2 = [
      {
        name: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.CODE_INFORMATION.NAME'
        ),
        datatype: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.CODE_INFORMATION.DATA_TYPE'
        ),
        definition: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.CODE_INFORMATION.DESCRIPTION'
        ),
      },
      {
        name: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.TENANT_INFORMATION.NAME'
        ),
        datatype: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.TENANT_INFORMATION.DATA_TYPE'
        ),
        definition: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.TENANT_INFORMATION.DESCRIPTION'
        ),
      },
      {
        name: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.TERM_INFORMATION.NAME'
        ),
        datatype: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.TERM_INFORMATION.DATA_TYPE'
        ),
        definition: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.TERM_INFORMATION.DESCRIPTION'
        ),
      },
      {
        name: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.UNIT_TYPE_INFORMATION.NAME'
        ),
        datatype: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.UNIT_TYPE_INFORMATION.DATA_TYPE'
        ),
        definition: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.UNIT_TYPE_INFORMATION.DESCRIPTION'
        ),
      },
      {
        name: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.UNIT_INFORMATION.NAME'
        ),
        datatype: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.UNIT_INFORMATION.DATA_TYPE'
        ),
        definition: `
          ${this.translateService.instant(
            'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.UNIT_INFORMATION.DESCRIPTION_1'
          )}
          ${this.translateService.instant(
            'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.UNIT_INFORMATION.DESCRIPTION_2'
          )}
        `,
      },
      {
        name: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.EFFECTIVE_DATE_INFORMATION.NAME'
        ),
        datatype: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.EFFECTIVE_DATE_INFORMATION.DATA_TYPE'
        ),
        definition: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.EFFECTIVE_DATE_INFORMATION.DESCRIPTION'
        ),
      },
      {
        name: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.OPEN_CONTRACT_INFORMATION.NAME'
        ),
        datatype: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.OPEN_CONTRACT_INFORMATION.DATA_TYPE'
        ),
        definition: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.OPEN_CONTRACT_INFORMATION.DESCRIPTION'
        ),
      },
      {
        name: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.DURATION_UNIT_INFORMATION.NAME'
        ),
        datatype: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.DURATION_UNIT_INFORMATION.DATA_TYPE'
        ),
        definition: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.DURATION_UNIT_INFORMATION.DESCRIPTION'
        ),
      },
      {
        name: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.DURATION_VALUE_INFORMATION.NAME'
        ),
        datatype: this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.DURATION_VALUE_INFORMATION.DATA_TYPE'
        ),
        definition: `
        ${this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.DURATION_VALUE_INFORMATION.DESCRIPTION_1'
        )}
        ${this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.DURATION_VALUE_INFORMATION.DESCRIPTION_2'
        )}
        ${this.translateService.instant(
          'CONTRACTS_PAGE.BODY.CREATE_NEW_CONTRACT_SECTION.TABLE_INFORMATION.DURATION_VALUE_INFORMATION.DESCRIPTION_3'
        )}
        `,
      },
    ];
